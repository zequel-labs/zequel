...
- Use the command palette (Cmd+K / Ctrl+K) to discover and run actions by name when you do not remember the shortcut.
...
- You can view the full shortcut list at any time by pressing **F1** to open the Help panel.
