...
Materialized views are supported only for **PostgreSQL** connections. They do not appear in the sidebar for MySQL, MariaDB, SQLite, DuckDB, ClickHouse, SQL Server, MongoDB, or Redis connections.
