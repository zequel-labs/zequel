...
2. Press **Cmd+S** (macOS) or **Ctrl+S** (Windows/Linux), or click the **Save** icon in the editor toolbar.
3. In the **Save Query** dialog, enter a **name** for the query (required) and an optional **description** to help you identify it later.
4. Click **Save**.
...
1. Right-click the query in the sidebar and select **Edit**.
2. Modify the name, description, or SQL content in the dialog that appears.
...
- [Query History](./history.md) -- View automatically logged queries.
